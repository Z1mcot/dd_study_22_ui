...
import 'package:dd_study_22_ui/ui/widgets/user_profile/subscribers/subscribers_list.dart';
...
import 'package:dd_study_22_ui/ui/widgets/user_profile/subscriptions/subscriptions_list.dart';
...
class TabNavigator extends StatelessWidget {
  ...
  Map<String, WidgetBuilder> _routeBuilders(BuildContext context,
          {TabNavigatiorArguments? args}) =>
      {
        ...
        TabNavigatorRoutes.userSubscribers: (context) => SubscribersList.create(
              args,
