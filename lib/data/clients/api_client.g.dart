...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<List<AttachMeta>> uploadFiles({required files}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<dynamic> addAvatarToUser(model) async {
    ...
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/Attachment/AddAvatarToUser',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<List<SimpleUser>> searchUsers(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<SimpleUser>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!
        .map((dynamic i) => SimpleUser.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  @override
  Future<dynamic> addComment(model) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
